...
def is_near_duplicate(
    ...
    The detection is based solely on the RapidFuzz token set ratio. If any of the
    recent messages are at least ``threshold`` similar, the candidate is considered
    a duplicate.
    """
